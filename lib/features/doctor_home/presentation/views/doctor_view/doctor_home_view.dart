...
import 'package:medi_link/features/doctor_home/presentation/views/doctor_view/widgets/doctor_home_view_body.dart';
...
class DoctorHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: const Scaffold(body: DoctorHomeViewBody()),
    );
  }
}
