...
class DoctorHomeAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UpdateDoctorDataCubit, UpdateDoctorDataState>(
      builder: (context, state) {

        final doctor = getDoctorData();
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      S.of(context).dr + ' ' + doctor.firstName,
              ...
              AppBarIconButton(
                onPressed: () {
                  ...
                  result.then((value) {
                    if (value == true) {
                      context.read<UpdateDoctorDataCubit>().getDoctorsData(
                        getDoctorData().id,
                      );
                    }
                  });
