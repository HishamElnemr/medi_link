...
import 'package:medi_link/features/home/presentation/views/patient_view/widgets/doctor_list_view_with_favorites.dart';
      ...
      builder: (context, state) {
        if (state is GetDoctorBySpecialitySuccess) {
          return state.doctorsBySpeciality.isEmpty
              ...
              : DoctorListViewWithFavorites(doctors: state.doctorsBySpeciality);
