...
import 'package:medi_link/features/booking/presentation/views/booking_view/widgets/booking_view_body_bloc_consumer.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: const BookingViewBodyBlocConsumer(),
      ),
    );
  }
}
