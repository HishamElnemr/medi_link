...
import 'package:medi_link/core/widgets/profile_view/personal_information.dart';
import 'package:medi_link/core/widgets/profile_view/profile_view.dart';
...
Route<dynamic> onGenerateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case RoutesName.profileView:
      return slideFromRightRoute(const ProfileView(), settings);
